...
- Constraint: NEVER modify openclaw.json directly without backup + validation [2026-02-28] [system:safety]- Constraint: LOW tasks → Groq/Moonshot small models; MEDIUM → OpenAI mid/Claude Sonnet; HIGH → Claude Opus/OpenAI flagship [2026-02-27] [system:models]
